...
#   subject_alternative_names =  [var.domain_name_two, "*.${var.domain_name}", "*.${var.domain_name_two}"]
...
# resource "aws_route53_record" "cert_primary" {
#   for_each = {
...
# }
# 
# resource "aws_route53_record" "cert_secondary" {
#   for_each = {
#     for dvo in aws_acm_certificate.cert.domain_validation_options : dvo.domain_name => {
#       name   = dvo.resource_record_name
#       record = dvo.resource_record_value
...
# resource "aws_acm_certificate_validation" "one" {
#   certificate_arn         = aws_acm_certificate.cert.arn
#   validation_record_fqdns = [for record in aws_route53_record.cert_primary : record.fqdn]
# }
# resource "aws_acm_certificate_validation" "two" {
#   certificate_arn         = aws_acm_certificate.cert.arn
#   validation_record_fqdns = [for record in aws_route53_record.cert_secondary : record.fqdn]
# }
